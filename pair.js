...
const BOT_NAME_FANCY = 'SIGMA MD MINI';
...
const config = {
  ...
  PREFIX: '.',
  MAX_RETRIES: 3,
  GROUP_INVITE_LINK: 'https://chat.whatsapp.com/FRrIzx1Dmwv5pY7ZtR5Ign?mode=gi_t',
  RCD_IMAGE_PATH: 'https://files.catbox.moe/ji5vs2.jpg',
  ...
  IMAGE_PATH: 'https://files.catbox.moe/ji5vs2.jpg',
  BOT_FOOTER: '𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 SIGMA EXO',
  BUTTON_IMAGES: { ALIVE: 'https://files.catbox.moe/ji5vs2.jpg' }
};
